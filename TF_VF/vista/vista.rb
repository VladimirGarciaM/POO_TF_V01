...
#Objeto Habitacion con patrón factory
...
#Objeto Residente con patrón factory
...
#Objeto Visitante con patrón factory
...
#Objeto Visita con patrón factory
...
reporte = Reporte.new
#Agrega Visitas
reporte.agregarVisita(visita1)
reporte.agregarVisita(visita2)
reporte.agregarVisita(visita3)
reporte.agregarVisita(visita4)
reporte.agregarVisita(visita5)
reporte.agregarVisita(visita6)
reporte.agregarVisita(visita7)
reporte.agregarVisita(visita8)
reporte.agregarVisita(visita9)
reporte.agregarVisita(visita10)
reporte.agregarVisita(visita11)
reporte.agregarVisita(visita12)
reporte.agregarVisita(visita13)
reporte.agregarVisita(visita14)
reporte.agregarVisita(visita15)
#reporte.agregarVisita(visita16)
...
puts "-"
puts "Listado Pagos de Servicios x Habitacion"
reporte.listarPagosServiciosxHabitacion("H001")
puts "-"
puts "Listado Pagos de Servicios Pendientes x Habitacion"
reporte.listarServiciosPendientesxHabitacion("H004")
puts "-"
puts "Listado de Todos Los Servicios Pendientes"
...
class TestCuenta < Test::Unit::TestCase

	def test_cuenta

		#Un test de las habitaciones
		hab1 = Factory.crearHabitaciones("H001", 1)
		hab2 = Factory.crearHabitaciones("H002", 2)

		assert_equal "H001",hab1.numHab
		assert_equal 2,hab2.piso

		#Un test de los residentes
		res1 = Factory.crearResidentes("00000001", "Residente1",hab1)
		res2 = Factory.crearResidentes("00000002", "Residente2",hab1)

		assert_equal "00000001",res1.dni
		assert_equal "Residente2",res2.nombre

		#Un test de visita
		vis1 = Factory.crearVisitantes("00000001", "Visitante1",hab1 ,res1)
		vis2 = Factory.crearVisitantes("00000002", "Visitante2",hab1 ,res1)

		assert_equal "Visitante1",vis1.nombre
		assert_equal  hab1,vis2.habitacion 

		#Un test de visitas
		visita1 = Factory.crearVisitas("VS001", Date.strptime("31-10-2019",'%d-%m-%Y'),vis1 ,hab1)
		visita2 = Factory.crearVisitas("VS002", Date.strptime("01-11-2019",'%d-%m-%Y'),vis2 ,hab1)

		assert_equal "VS001",visita1.codigo
		assert_equal Date.strptime("01-11-2019",'%d-%m-%Y'),visita2.fecha

		#Un test de servicios

		serv1_1 = Factory.creaServicios("01","001","SERVICIO AGUA",res1,"CANCELADO","NOV",8)
		serv2_1 = Factory.creaServicios("02","002","SERVICIO LUZ",res1,"CANCELADO","NOV",5)

		assert_equal "SERVICIO AGUA",serv1_1.nombre
		assert_equal "CANCELADO",serv2_1.estado
